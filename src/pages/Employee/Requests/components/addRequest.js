  ...
  return (
    <Formik
      ...
      onSubmit={(values, { resetForm }) => {
        if (leavePdf === null) {
          toast.success("Please upload any proof or something to get approved your leave");
          return false;
        }
    ...
    >
      {({ values, errors }) => {
        return (
          <div className="modal fade" id="addRequest" tabindex="-1" aria-labelledby="AddRequestLabel" aria-hidden="true">
                ...
                <div className="modal-body">
                  ...
                  <Form>
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-6">
                        <div className="form-group">
                          <TextArea type="date" name="reason" placeholder="Reason" />
                        </div>
                      </div>
                    </div>
                    <div className='row'>
                      <div className="col-md-6">
                        <div className="form-group">
                          <TextInput type="file" name="leavePdf" placeholder="Leave PDF" onChange={(e) => { setLeavePdf(e.target.files[0]) }} />
                        </div>
                      </div>
                    </div>
